...
class Todo extends React.Component {
    render() {
        ...
        return(
            <div onClick={() => changeTodo(this.props.id)} className={this.props.id === 1 ? 'first-todo todo-wrapper' : this.props.id === this.props.total ? 'last-todo todo-wrapper' : this.props.total === 1 ? 'only-todo todo-wrapper': 'middle-todo todo-wrapper'}>
